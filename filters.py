...
class DateFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :param approach: A `CloseApproach` on which to evaluate this filter.
        :return: The value of the date/time variable in date format.
        """
...
class VelocityFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :param approach: A `CloseApproach` on which to evaluate this filter.
        :return: The value of the velocity variable.
        """
...
class DiameterFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :param approach: A `CloseApproach` on which to evaluate this filter.
        :return: The value of the diameter variable.
        """
        return approach.neo.diameter


class HazardousFilter(AttributeFilter):
    """A class to filter the hazardous parameter."""
    @classmethod
    def get(cls, approach):
        """To get access to the hazardous attribute.

        :param approach: A `CloseApproach` on which to evaluate this filter.
        :return: The value of the hazardous variable.
        """
